<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:rsd="https://www.metanorma.org/ns/rsd" xmlns:mathml="http://www.w3.org/1998/Math/MathML" xmlns:xalan="http://xml.apache.org/xalan" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" version="1.0">
	...
	<xsl:variable name="contents">
		<contents>
			...
			<xsl:apply-templates select="/rsd:rsd-standard/rsd:sections/rsd:terms" mode="contents"> <!-- Terms and definitions -->
				<xsl:with-param name="sectionNum" select="count(/rsd:rsd-standard/rsd:sections/rsd:clause[@id='_scope']) +                                      count(/rsd:rsd-standard/rsd:bibliography/rsd:references[@id = '_normative_references' or @id = '_references']) + 1"/>
			</xsl:apply-templates>
				
			<xsl:apply-templates select="/rsd:rsd-standard/rsd:sections/*[local-name() != 'terms' and not(@id='_scope') ]" mode="contents">
				<xsl:with-param name="sectionNumSkew" select="count(/rsd:rsd-standard/rsd:sections/rsd:clause[@id='_scope']) +                                      count(/rsd:rsd-standard/rsd:bibliography/rsd:references[@id = '_normative_references' or @id = '_references']) +                                     count(/rsd:rsd-standard/rsd:sections/rsd:terms)"/>	
			</xsl:apply-templates>
	...
	<xsl:template name="getLevel">
		...
		<xsl:variable name="level">
			<xsl:choose>
				<xsl:when test="ancestor::rsd:preface">
